	...
	return (
		<Sheet>
			<SheetTrigger asChild>
				<Button variant="outline" className="fixed left-4 top-1/2 -translate-y-1/2 rotate-90 origin-left">
					View Sources
				</Button>
			</SheetTrigger>
							...
							<div className="flex items-start justify-between gap-4">
								<div className="flex-1">
									<div className="flex items-center gap-2 mb-2">
										...
										{source.verified && <CheckCircle className="w-4 h-4 text-green-500" />}
									</div>
									...
									{source.rating && (
										<div className="flex items-center gap-1 text-sm text-yellow-500 mb-2">
											...
											<span className="text-muted-foreground ml-1">({source.rating})</span>
										</div>
									)}
									<a
										href={source.url}
