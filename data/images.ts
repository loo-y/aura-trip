...
export const galleryImages: GalleryImage[] = [
	// Day 1
	{
		...
		height: 853,
		description:
			'Start your journey at the majestic Kyoto Imperial Palace, where centuries of Japanese history come alive through traditional architecture and meticulously maintained gardens.',
		time: '9:00 AM',
		day: 1,
		type: 'attraction',
		price: 0,
	...
	},
	{
		...
		height: 853,
		description:
			'Visit the iconic Golden Pavilion, a Zen temple whose top two floors are completely covered in gold leaf, reflecting beautifully in the surrounding pond.',
		time: '11:30 AM',
		day: 1,
		type: 'attraction',
		price: 25,
	...
	// Day 2
	{
		...
		height: 853,
		description:
			'Start your second day with an early morning walk through the enchanting Arashiyama Bamboo Grove, where towering green stalks filter the sunlight and create an otherworldly atmosphere.',
		time: '8:00 AM',
		day: 2,
		type: 'attraction',
		price: 0,
